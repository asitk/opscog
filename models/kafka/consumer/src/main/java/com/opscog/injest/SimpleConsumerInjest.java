...
public class SimpleConsumerInjest {
  ...
  public void run(long maxReads, String topic, int partition, List<String> seedBrokers, int port)
    ...
    long readOffset =
        getLastOffset(
            consumer, topic, partition, kafka.api.OffsetRequest.EarliestTime(), clientName);
  ...
  /*public static void main(String args[]) {
    ...
    SimpleConsumerInjest example = new SimpleConsumerInjest();

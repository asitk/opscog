package com.opscog.entry;

/** Created by asitk on 4/8/16. */
import com.opscog.entry.infra.*;
import com.opscog.util.CassandraDB;
import com.opscog.util.JacksonWrapper;
import javax.ws.rs.*;
...
public class service {
  ...
  public Response queryabsolute(@QueryParam("rawq") String rawq) {
    ...
    try {
      ...
      Response.ResponseBuilder builder =
          Response.ok(strResult.toString(), MediaType.APPLICATION_JSON);
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @Consumes(MediaType.APPLICATION_JSON)
  public Response getdeploymentmarkers(
      @QueryParam("deployment_id") String deployment_id,
    ...
    try {
      ...
      Deployment.DeploymentTimelineMarker TimeLineMarkers =
          Deployment.getTimelineMarkers(customer_id, deployment_id, tr);
      ...
      Response.ResponseBuilder builder =
          Response.ok(TimeLineMarkers.toString(), MediaType.APPLICATION_JSON);
      builder.cacheControl(cc);
      return builder.build();
    } catch (Exception ex) {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @Consumes(MediaType.APPLICATION_JSON)
  public Response getdeploymentdetail(
      @QueryParam("deployment_id") String deployment_id,
      @QueryParam("customer_id") String customer_id,
      @QueryParam("sts") Long sts,
      @QueryParam("ets") Long ets) {
    ...
    try {
      ...
      CassandraDB.TimeRange tr = new CassandraDB.TimeRange(sts, ets);
      List<Deployment.DeploymentDetail> DeploymentDetail =
          Deployment.getDetails(customer_id, deployment_id, tr);
      ...
      if (jsonDeploymentDetail.size() > 0) {
        ...
        Response.ResponseBuilder builder =
            Response.ok(InnerDetail.toJSONString(), MediaType.APPLICATION_JSON);
        builder.cacheControl(cc);
        return builder.build();
      } else {
        Response.ResponseBuilder builder = Response.ok("{}", MediaType.APPLICATION_JSON);
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @Consumes(MediaType.APPLICATION_JSON)
  public Response getdeploymentsnapshot(
      @QueryParam("deployment_id") String deployment_id,
      @QueryParam("customer_id") String customer_id,
      @QueryParam("sts") Long sts,
      @QueryParam("ets") Long ets) {
    ...
    try {
      ...
      CassandraDB.TimeRange tr = new CassandraDB.TimeRange(sts, ets);
      List<Deployment.DeploymentSnapshot> DeploymentSnapshot =
          Deployment.getSnapshot(customer_id, deployment_id, tr);
      ...
      if (jsonDeploymentSnapshot.size() > 0) {
        ...
        Response.ResponseBuilder builder =
            Response.ok(InnerSnapshot.toJSONString(), MediaType.APPLICATION_JSON);
        builder.cacheControl(cc);
        return builder.build();
      } else {
        Response.ResponseBuilder builder = Response.ok("{}", MediaType.APPLICATION_JSON);
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @Consumes(MediaType.APPLICATION_JSON)
  public Response getdeploymentconnection(
      @QueryParam("deployment_id") String deployment_id,
      @QueryParam("customer_id") String customer_id,
      @QueryParam("sts") Long sts,
      @QueryParam("ets") Long ets) {
    ...
    try {
      ...
      CassandraDB.TimeRange tr = new CassandraDB.TimeRange(sts, ets);
      List<Deployment.DeploymentConnection> DeploymentConnection =
          Deployment.getConnection(customer_id, deployment_id, tr);
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @Consumes(MediaType.APPLICATION_JSON)
  public Response getdeploymentservice(
      @QueryParam("deployment_id") String deployment_id,
      @QueryParam("customer_id") String customer_id,
      @QueryParam("sts") Long sts,
      @QueryParam("ets") Long ets) {
    ...
    try {
      ...
      CassandraDB.TimeRange tr = new CassandraDB.TimeRange(sts, ets);
      List<Deployment.DeploymentService> DeploymentService =
          Deployment.getService(customer_id, deployment_id, tr);
  ...
  public Response getdeploymentmarkers(
    ...
    try {
      ...
      CassandraDB.TimeRange tr = new CassandraDB.TimeRange(sts, ets);
      Cluster.ClusterTimelineMarker TimeLineMarkers =
          Cluster.getTimelineMarkers(customer_id, deployment_id, cluster_id, tr);
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @Consumes(MediaType.APPLICATION_JSON)
  public Response getclusterdetail(
      @QueryParam("deployment_id") String deployment_id,
      @QueryParam("customer_id") String customer_id,
      @QueryParam("cluster_id") String cluster_id,
      @QueryParam("sts") Long sts,
    ...
    try {
      ...
      CassandraDB.TimeRange tr = new CassandraDB.TimeRange(sts, ets);
      List<Cluster.ClusterDetail> ClusterDetail =
          Cluster.getDetails(customer_id, deployment_id, cluster_id, tr);
  ...
  public Response getclustersnapshot(
    ...
    try {
      JSONParser parser = new JSONParser();
      CassandraDB.TimeRange tr = new CassandraDB.TimeRange(sts, ets);
      List<Cluster.ClusterSnapshot> ClusterSnapshot =
          Cluster.getSnapshot(customer_id, deployment_id, cluster_id, tr);
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @Consumes(MediaType.APPLICATION_JSON)
  public Response getclusterconnection(
      @QueryParam("deployment_id") String deployment_id,
      @QueryParam("customer_id") String customer_id,
      @QueryParam("cluster_id") String cluster_id,
      @QueryParam("sts") Long sts,
    ...
    try {
      ...
      CassandraDB.TimeRange tr = new CassandraDB.TimeRange(sts, ets);
      List<Cluster.ClusterConnection> ClusterConnection =
          Cluster.getConnection(customer_id, deployment_id, cluster_id, tr);
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @Consumes(MediaType.APPLICATION_JSON)
  public Response getclusterservice(
      @QueryParam("deployment_id") String deployment_id,
      @QueryParam("customer_id") String customer_id,
      @QueryParam("cluster_id") String cluster_id,
      @QueryParam("sts") Long sts,
    ...
    try {
      ...
      CassandraDB.TimeRange tr = new CassandraDB.TimeRange(sts, ets);
      List<Cluster.ClusterService> ClusterService =
          Cluster.getService(customer_id, deployment_id, cluster_id, tr);
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @Consumes(MediaType.APPLICATION_JSON)
  public Response getnodemarkers(
      @QueryParam("deployment_id") String deployment_id,
      @QueryParam("customer_id") String customer_id,
      @QueryParam("cluster_id") String cluster_id,
    ...
    try {
      ...
      CassandraDB.TimeRange tr = new CassandraDB.TimeRange(sts, ets);
      Node.NodeTimelineMarker TimeLineMarkers =
          Node.getTimelineMarkers(customer_id, deployment_id, cluster_id, node_id, tr);
  ...
  public Response getnodedetail(
    ...
    try {
      ...
      CassandraDB.TimeRange tr = new CassandraDB.TimeRange(sts, ets);
      List<Node.NodeDetail> NodeDetail =
          Node.getDetails(customer_id, deployment_id, cluster_id, node_id, tr);
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @Consumes(MediaType.APPLICATION_JSON)
  public Response getnodesnapshot(
      @QueryParam("deployment_id") String deployment_id,
      @QueryParam("customer_id") String customer_id,
      @QueryParam("cluster_id") String cluster_id,
      @QueryParam("node_id") String node_id,
    ...
    try {
      JSONParser parser = new JSONParser();
      CassandraDB.TimeRange tr = new CassandraDB.TimeRange(sts, ets);
      List<Node.NodeSnapshot> NodeSnapshot =
          Node.getSnapshot(customer_id, deployment_id, cluster_id, node_id, tr);
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @Consumes(MediaType.APPLICATION_JSON)
  public Response getnodeconnection(
      @QueryParam("deployment_id") String deployment_id,
      @QueryParam("customer_id") String customer_id,
      @QueryParam("cluster_id") String cluster_id,
      @QueryParam("node_id") String node_id,
    ...
    try {
      ...
      CassandraDB.TimeRange tr = new CassandraDB.TimeRange(sts, ets);
      List<Node.NodeConnection> NodeConnection =
          Node.getConnection(customer_id, deployment_id, cluster_id, node_id, tr);
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @Consumes(MediaType.APPLICATION_JSON)
  public Response getnodeservice(
      @QueryParam("deployment_id") String deployment_id,
      @QueryParam("customer_id") String customer_id,
      @QueryParam("cluster_id") String cluster_id,
      @QueryParam("node_id") String node_id,
    ...
    try {
      ...
      CassandraDB.TimeRange tr = new CassandraDB.TimeRange(sts, ets);
      List<Node.NodeService> NodeService =
          Node.getService(customer_id, deployment_id, cluster_id, node_id, tr);
